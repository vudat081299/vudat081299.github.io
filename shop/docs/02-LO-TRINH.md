...
[01-BOI-CANH-VA-CO-HOI.md](01-BOI-CANH-VA-CO-HOI.md), và **đặc biệt là sau §5 của tài liệu đó**:
...
3. **Ngưỡng giết phải chọn TRƯỚC khi chạy.** Chọn sau là tự lừa mình. Các ngưỡng trong tài liệu
   ...
   xong thì tôn trọng.
4. **Chưa có gì được xây khi chưa biết giá vốn `V`.** Xem [01](01-BOI-CANH-VA-CO-HOI.md) §2.
5. **Thử cái không cần code trước.** Nếu một giả định kiểm được bằng một tin nhắn, một listing
   mới hay một đoạn chữ dán sẵn, thì kiểm bằng cách đó — [01](01-BOI-CANH-VA-CO-HOI.md) §5. Chỉ
...
|---|---|---|
| **Khách không chọn được mùi, và điều đó chặn mua hàng** | Một đoạn trả lời mẫu dán vào tin nhắn ([01](01-BOI-CANH-VA-CO-HOI.md) §5, thử nghiệm 4). Nếu nó không đủ thì mới tới **Tìm mùi** — một trang, không giỏ hàng, không thanh toán | Landing page, giỏ hàng, checkout, hộp quà |
...
| **AOV thấp vì không ai nghĩ tới việc mua nhiều cây** | Hai listing bộ quà **ngay trên Shopee/TikTok** ([01](01-BOI-CANH-VA-CO-HOI.md) §5, thử nghiệm 2). **Không cần web** | Toàn bộ `shop/` |
| **Khách mua rồi không quay lại, nên chị ấy phải mua khách mới mãi** | Một danh sách khách cũ và một tin nhắn nhắn tay ([01](01-BOI-CANH-VA-CO-HOI.md) §5, thử nghiệm 1) | CRM, email marketing, tài khoản khách hàng |
...
2. **Chưa ai biết giả định nào là rủi ro nhất.** Nó phụ thuộc vào các con số ở
   [01](01-BOI-CANH-VA-CO-HOI.md) §1 mà ta chưa có. Nghĩa là **buổi gặp đầu tiên chính là việc
   chọn MVP**, và đó là lý do [04-DAM-PHAN.md](04-DAM-PHAN.md) dành phần lớn dung lượng cho việc
...
ấy**, miễn phí. Chi tiết đầy đủ ở [BAO-CAO-HIEN-TRANG.md](../BAO-CAO-HIEN-TRANG.md).
...
| **Tìm mùi** (`scent-finder.html`) | Khách không biết chọn mùi nào, và **việc đó đang chặn mua hàng** | Số tin nhắn hỏi chọn mùi mỗi ngày, trước/sau; tỉ lệ người làm xong quiz rồi thêm vào giỏ | Nếu sau 4 tuần tỉ lệ tin nhắn hỏi chọn mùi **không giảm**. Và bỏ sớm hơn nữa nếu thử nghiệm 4 ở [01](01-BOI-CANH-VA-CO-HOI.md) §5 cho thấy **một đoạn chữ dán sẵn đã đủ** |
| **Hộp quà** (`gift.html`) | Khách mua nến 300k để tặng, và họ sẽ mua nhiều cây hơn nếu có hộp + thiệp | Tỉ lệ đơn từ 2 cây trở lên; AOV | Sau 100 đơn trực tiếp mà tỉ lệ đơn nhiều cây không đổi. Và **kiểm giả định này trên sàn trước** (thử nghiệm 2, [01](01-BOI-CANH-VA-CO-HOI.md) §5) — nếu bộ quà không bán được ngay cả trên sàn thì `gift.html` không cứu được |
...
moi ra số — xem [01](01-BOI-CANH-VA-CO-HOI.md) §7.
...
ấy. Xem [04-DAM-PHAN.md](04-DAM-PHAN.md) §1.
...
hạn đó. Xem [05-KIEN-TRUC.md](05-KIEN-TRUC.md).
...
trả tin nhắn tốt hơn. Lập luận đầy đủ ở [01](01-BOI-CANH-VA-CO-HOI.md) §7. Đây là một kết cục
...
GitHub Pages"** — kiến trúc ở [05-KIEN-TRUC.md](05-KIEN-TRUC.md).
...
lại sau khi biết `V`** — xem phép tính độ nhạy ở [01](01-BOI-CANH-VA-CO-HOI.md) §4.
...
- Thu thập và nhắn tin cho khách là **xử lý dữ liệu cá nhân**. Quy định cụ thể cho việc gửi tin
  ...
  [03](03-DOI-THU-VA-TICH-HOP.md) §5.
...
| Không xây | Vì sao |
|---|---|
| **POS / ERP đầy đủ** | Đã được giải quyết trọn vẹn ở mức 250.000–750.000₫/tháng [đã kiểm — xem [03](03-DOI-THU-VA-TICH-HOP.md)]. Xây lại là **phá huỷ giá trị**: tốn hàng trăm giờ để ra một thứ tệ hơn cái mua được trong một buổi chiều. |
...
| **Apple Pay** | Cần một cổng thanh toán, chứng chỉ Apple, xác thực tên miền, và một endpoint máy chủ [đã kiểm: [BAO-CAO-HIEN-TRANG.md](../BAO-CAO-HIEN-TRANG.md) §3]. Bốn thứ cho một cách trả tiền mà VietQR đã làm được, miễn phí. |
...
[03](03-DOI-THU-VA-TICH-HOP.md) §2), trình dựng hộp quà, và việc trang không trông giống một
...
Đọc tiếp: [03-DOI-THU-VA-TICH-HOP.md](03-DOI-THU-VA-TICH-HOP.md) · [04-DAM-PHAN.md](04-DAM-PHAN.md) ·
kiến trúc ở [05-KIEN-TRUC.md](05-KIEN-TRUC.md) · nợ kỹ thuật ở [NO-KY-THUAT.md](NO-KY-THUAT.md) ·
quay lại [00-DOC-CAI-NAY-TRUOC.md](00-DOC-CAI-NAY-TRUOC.md)
