...
**Còn nợ:** chưa duyệt tay chất lượng từng `d` sau rút gọn (mới soi mẫu — 609 cái). Merge với
đợt (b): 3 truyện của tôi trùng truyện origin đã bị bỏ (Eratosthenes, gà Mike, marathon 1904);
7 truyện còn lại chuyển sang schema `kieu`, gộp vào `dot-08.json`.
