#!/usr/bin/env python3
"""Cổng chất lượng cho cooking/ — các trang công thức nấu ăn tự chứa, mỗi trang một file.

Vì sao cần: mỗi trang ở đây là một tài liệu dài (2.700–4.700 dòng), tự chứa cả CSS lẫn JS
...
Cùng bộ kiểm với pages/tools/lint-pages.py — tách riêng vì cooking/ là một folder độc lập
(bốn trang bếp: Việt, Âu mặn, Bánh Âu, Hàn), có cổng riêng theo đúng kiến trúc repo.
...
Chạy:
  python3 cooking/tools/lint-cooking.py          # tất cả trang
  python3 cooking/tools/lint-cooking.py a.html   # vài trang cụ thể
